...
export function LandingNav({ signInLabel, getStartedLabel, dashboardLabel, healthLabel = "Health" }: LandingNavProps) {
          ...
          {isAuthenticated ? (
            <>
              ...
              <a
                ...
                className="border-brand/30 text-brand hover:bg-brand/10 flex items-center gap-1 rounded-full border px-3 py-1.5 text-xs font-semibold transition-colors"
              >
