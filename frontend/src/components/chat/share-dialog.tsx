  ...
  const handleGenerateLink = async () => {
    ...
    try {
      ...
      if (share?.share_token) {
        const url = `${window.location.origin}/shared?token=${share.share_token}`;
        setShareLink(url);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>{"Share this conversation with other users or generate a public link."}</DialogDescription>
        </DialogHeader>
