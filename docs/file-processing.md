...
### Vector Storage
Documents are uploaded to S3 and indexed via **AWS Bedrock Knowledge Base**.
Configure with `BEDROCK_KNOWLEDGE_BASE_ID`, `BEDROCK_KB_DATA_SOURCE_ID`,
`BEDROCK_KB_S3_BUCKET`, and `BEDROCK_KB_S3_PREFIX`.
