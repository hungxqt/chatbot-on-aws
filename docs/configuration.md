...
| `BEDROCK_KNOWLEDGE_BASE_ID` | (empty) | Bedrock Knowledge Base ID |
| `BEDROCK_KB_DATA_SOURCE_ID` | (empty) | Bedrock KB data source ID |
| `BEDROCK_KB_S3_BUCKET` | (empty) | S3 bucket for KB documents |
| `BEDROCK_KB_S3_PREFIX` | `rag-documents/` | S3 key prefix for KB documents |
...
| `S3_RAG_BUCKET` | `ai_agent-rag` | Bucket name |
