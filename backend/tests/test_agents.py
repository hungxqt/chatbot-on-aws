...
class TestAssistantAgent:
    ...
    def test_agent_property_creates_agent(self, mock_model, mock_provider, mock_infer):
        """Test agent property creates agent on first access."""
        mock_infer.side_effect = lambda x: x
        agent = AssistantAgent()
        _ = agent.agent
    ...
    @patch("app.agents.assistant.BedrockProvider")
    @patch("app.agents.assistant.BedrockConverseModel")
    def test_agent_property_caches_agent(self, mock_model, mock_provider, mock_infer):
